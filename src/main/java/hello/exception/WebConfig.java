...
public class WebConfig implements WebMvcConfigurer {
    ...
    /* 스프링 인터셉터, HandlerExceptionResolver
    @Override
    ...
    */
    ...
    public FilterRegistrationBean logFilter() {
        ...
        filterRegistrationBean.setDispatcherTypes(DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR);
